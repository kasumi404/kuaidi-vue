<template>
    <div>
		<header class="header">物业收入管理</header>
		<div class="table_nav">
			...
			<el-button class="nav_addBtn" type="primary" @click="addDialogFormVisible = true">添加收入信息</el-button>
		</div>
		<div class="table_container">
		    ...
		    <el-dialog title="添加新收入信息" :visible.sync="addDialogFormVisible">
				...
				<el-dialog title="编辑收入信息" :visible.sync="updateDialogFormVisible">
				  	<el-form :rules="buildrules" :model="updateHolderForm" ref="updateHolderForm" label-width="110px" class="form build_form">
						<el-form-item label="单元业主">
							<el-select :disabled="true" class="query_select" v-model="addHolderForm.holdersex" placeholder="吴镇升">
							    <el-option
							      v-for="item in holderSexOptions"
							      :key="item.value"
							      :label="item.label"
