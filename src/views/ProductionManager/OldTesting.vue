<template>
  <div id="oldTesting-container">
    <div class="form-container">
      <br>
      <br>
      <div class="explaintitle">单箱检测</div>
      <el-col :span="2"/>
    ...
    return {
      ...
      oldTestingForm: {
        testingParameters: [// 测试模块数据
          { label: 'SOC(%)', data: '1', Unqualified: false, name: '' },
          { label: 'DCR(Ω)', data: '2', Unqualified: false, name: '' },
          { label: '模块压差(V)', data: '3', Unqualified: false, name: '' },
          { label: '模块温差(°C)', data: '4', Unqualified: false, name: '' },
          { label: '模块动态压差(V)', data: '5', Unqualified: false, name: '' },
          { label: '老化截止SOC(%)', data: '6', Unqualified: false, name: '' },
          { label: '电流精度(A)', data: '7', Unqualified: false, name: '' },
          { label: '老化工步数', data: '8', Unqualified: false, name: '' },
          { label: '老化文件', data: '9', Unqualified: false, name: '' }
        ],
        text: '1'
      },
