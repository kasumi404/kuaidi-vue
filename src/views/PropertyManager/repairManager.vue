<template>
    <div>
		<header class="header">住户报修管理</header>
		<div class="table_nav">
			...
			<el-button class="nav_addBtn" type="primary" @click="addDialogFormVisible = true">添加报修信息</el-button>
		</div>
			...
			<el-table
		      ...
		      <el-table-column
			      ...
			      <template slot-scope="scope">
			        <el-button
			          size="mini"
			          @click="handleEdit(scope.$index, scope.row)" :disabled="scope.$index !=2">处理</el-button>
			        <el-button
			          size="mini"
			          type="danger"
				  	...
				  	<el-form :rules="buildrules" :model="addHolderForm" ref="addHolderForm" label-width="110px" class="form build_form">
						...
						<el-form-item label="单元业主">
				  		...
				  		<el-form-item label="报修类型" prop="holdername">
							<el-input v-model="addHolderForm.holdername" placeholder="请输入单元业主"></el-input>
						</el-form-item>
					    <el-form-item label="报修内容" prop="holderword">
							<el-input v-model="addHolderForm.holderword" placeholder="请输入职业"></el-input>
						</el-form-item>
						<el-form-item label="报修结果" prop="holdercall">
							<el-input v-model="addHolderForm.holdercall" placeholder="请输入联系电话"></el-input>
						</el-form-item>
				  	</el-form>
